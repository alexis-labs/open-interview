...
const SOUND_PARAMS: Record<SoundId, ZzfxParams> = {
  ...
  [SOUND_IDS.paper]: [0.2, 0.08, 1180, 0.006, 0.03, 0.12, 4, 1.25, -55, 0, 0, 0, 0, 0.68, 0, 2],
  [SOUND_IDS.uiHover]: [0.16, 0.08, 1350, 0.004, 0.012, 0.075, 4, 1.2, -38, 0, 0, 0, 0, 0.62, 0, 2],
  [SOUND_IDS.uiConfirm]: [0.2, 0.06, 820, 0.006, 0.026, 0.13, 4, 1.3, -72, 0, 0, 0, 0, 0.5, 0, 2],
